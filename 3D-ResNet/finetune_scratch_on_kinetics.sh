...
python utils/scratch_json.py ${base_folder}/TrainTestlist None
...
--result_path results-scratch-18 --sample_duration 45 --dataset ucf101 --n_classes 400 --n_finetune_classes 3 \
