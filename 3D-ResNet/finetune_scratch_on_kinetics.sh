...
--result_path results-scratch-101 --sample_duration 45 --dataset ucf101 --n_classes 400 --n_finetune_classes 3 \
--pretrain_path models/resnet-101-kinetics.pth --ft_begin_index 3 \
--model resnet --model_depth 101 --resnet_shortcut B --batch_size 16 --n_threads 1 --checkpoint 20